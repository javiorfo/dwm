...
static const char *fonts[]          = { "Iosevka NF:size=10:antialias=true:autohint=true:style=bold" };
...
static const char col_cyan2[]       = "#767676";
...
static const char *dmenucmd[] = { "dmenu_run", "-c", "-l", "5", "-m", dmenumon, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, NULL };
